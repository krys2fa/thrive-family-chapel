    ...
    <div className="banner">
      <div className="info">
        ...
        <div>
          ...
          <div className="times"><FaCalendarAlt /><span className="time">Sundays @ 8:30 AM</span></div>
          <div className="times"><FaCalendarAlt /><span className="time">Wednesdays @ 8:30 PM</span></div>
          <div className="times"><FaCalendarAlt /><span className="time">Fridays @ 7:00 PM</span></div>
        </div>
